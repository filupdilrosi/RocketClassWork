              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Text('Select your Rocket Type:',
                  ...
                  Row(
                    ...
                    children: [
                      CharacterButton(
                        ...
                        selected: character == Character.Pink,
                        onSelectChar: () {
                          setState(() {
                            character = Character.Pink;
                          });
                      ...
                      CharacterButton(
                        ...
                        selected: character == Character.Orange,
                        onSelectChar: () {
                          setState(() {
                            character = Character.Orange;
                          });
                  ...
                  Row(
                    ...
                    children: [
                      CharacterButton(
                        character: Character.White,
                        selected: character == Character.White,
                        onSelectChar: () {
                          setState(() {
                            character = Character.White;
                          });
